...
static ssize_t emac_ptp_sysfs_cmd(struct device *dev, struct device_attribute *attr,
...
static ssize_t emac_ptp_sysfs_mtnp_show(
	struct device *dev,
...
static ssize_t emac_ptp_sysfs_slam(
	struct device *dev,
	struct device_attribute *attr,
	const char *buf,
	size_t count)
 ...
 */
static ssize_t emac_ptp_sysfs_cadj(
	struct device *dev,
	struct device_attribute *attr,
	const char *buf,
	size_t count)
 ...
 */
static ssize_t emac_ptp_sysfs_fadj(
	struct device *dev,
	struct device_attribute *attr,
	const char *buf,
	size_t count)
...
static DEVICE_ATTR(cmd, S_IWUSR|S_IWGRP, NULL, emac_ptp_sysfs_cmd);
static DEVICE_ATTR(tstamp, S_IRUSR|S_IRGRP, emac_ptp_sysfs_tstamp_show, NULL);
static DEVICE_ATTR(mtnp, S_IRUSR|S_IRGRP, emac_ptp_sysfs_mtnp_show, NULL);
static DEVICE_ATTR(slam, S_IWUSR|S_IWGRP, NULL, emac_ptp_sysfs_slam);
static DEVICE_ATTR(cadj, S_IWUSR|S_IWGRP, NULL, emac_ptp_sysfs_cadj);
static DEVICE_ATTR(fadj, S_IWUSR|S_IWGRP, NULL, emac_ptp_sysfs_fadj);
